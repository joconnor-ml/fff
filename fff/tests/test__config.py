# fff/server/tests/test_config.py
...
from fff.server import app


class TestDevelopmentConfig(TestCase):

    def create_app(self):
        app.config.from_object('fff.server.config.DevelopmentConfig')
        return app
...
class TestProductionConfig(TestCase):
    ...
    def create_app(self):
        app.config.from_object('fff.server.config.ProductionConfig')
        return app
